...
const impostoDeRendaPessoaJuridica = new ImpostoDeRendaPessoaJuridica('Luquinhas', 751, 55)

const impostoPessoaJuridica = impostoDeRendaPessoaJuridica.calcularImposto()

console.log( impostoPessoaJuridica)

const impostoDeRendaPessoaFisica = new ImpostoDeRendaPessoaFisica('Barcelo', 880, 95)
